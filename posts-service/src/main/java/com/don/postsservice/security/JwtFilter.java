 ...
 * Also, since in some cases when working with posts, we might need the id of the user, we also store the id and email of the user
 * in a context object that gets updated in every request.
 */
@Component
@Slf4j @Getter
